  ...
  return (
    ...
    >
      ...
      >
        ...
        >
         Passionate about creating interactive web solutions.<br />
          Focused on speed, usability, and modern user experience.
</motion.p>
        ...
        >
          <Badge className="text-xs bg-pink-500">Creative Thinker</Badge>
          <Badge className="text-xs bg-pink-500">Problem Solving</Badge>
          <Badge className="text-xs bg-pink-500">Adaptable</Badge>
        </motion.div>
      </motion.div>
